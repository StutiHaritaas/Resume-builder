class DetailsController < ApplicationController
  ...
  private
    ...
    def detail_params
      params.require(:detail).permit(:name, :avatar, :job_title, :Years_Of_Experience, :primary_skiils, :secondary_skills, :company, :position, :start_date, :end_date, :description, :title, :tech_stack, :desc, :school_name, :degree, :grade)
    end
end
