...
class ProfilesTest < ApplicationSystemTestCase
  ...
  test "should create profile" do
    ...
    fill_in "Years of experience", with: @profile.Years_Of_Experience
    fill_in "Skills", with: @profile._skills
    fill_in "First name", with: @profile.first_name
    fill_in "Last name", with: @profile.last_name
    fill_in "Primary skills", with: @profile.primary_skills
    fill_in "Secondary", with: @profile.secondary
